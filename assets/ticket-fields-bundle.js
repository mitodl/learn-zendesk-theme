...
function LookupField({ field, userId, organizationId, onChange, visibleFields, buildLookupFieldOptions, renderOption, }) {
    ...
    switch (field.type) {
        ...
        case "lookup":
            return (jsxRuntimeExports.jsx(LookupField, { field: field, userId: userId, organizationId: organizationField !== null
                    ...
                    : defaultOrganizationId, visibleFields: visibleFields, onChange: (value) => handleChange(field, value), buildLookupFieldOptions: buildLookupFieldOptions, renderOption: renderLookupFieldOption }, field.name));
        default:
